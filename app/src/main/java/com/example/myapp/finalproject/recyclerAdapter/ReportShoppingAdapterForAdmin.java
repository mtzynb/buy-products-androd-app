...
public class ReportShoppingAdapterForAdmin extends RecyclerView.Adapter<ReportShoppingAdapterForAdmin.ReportShoppingCartHistoryViewHolder>{

    private Context context;
    private List<OrderHistory> orderHistoryList;


    public ReportShoppingAdapterForAdmin(Context context, List<OrderHistory> orderHistoryList) {
    ...
    @Override
    public ReportShoppingCartHistoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(context);
        View mView=inflater.inflate(R.layout.report_shopping_for_admin,parent,false);

        ReportShoppingCartHistoryViewHolder holder=new ReportShoppingCartHistoryViewHolder(mView);
        return holder;
    ...
    @Override
    public void onBindViewHolder(ReportShoppingCartHistoryViewHolder holder, int position) {


        OrderHistory orderHistory = orderHistoryList.get(position);

        final String customerUsername = orderHistory.getCustomerUsername();
        ...
        holder.tvCustomerUsername.setText(customerUsername);
    ...
    public class ReportShoppingCartHistoryViewHolder extends RecyclerView.ViewHolder {

        public TextView tvUsername;
        public TextView tvCustomerUsername;
        ...
        public ReportShoppingCartHistoryViewHolder(View itemView) {
            super(itemView);

            tvUsername=itemView.findViewById(R.id.tvUserName);
            tvCustomerUsername=itemView.findViewById(R.id.tvCustomerUsername);
